...
export default function PublicBrainPage() {
  ...
  if (loading) {
    return (
      <div className="mx-auto flex min-h-screen max-w-3xl flex-col gap-4 px-4 py-16">
    ...
    <div className="relative min-h-screen overflow-hidden px-4 py-16">
      ...
      >
        ...
        <div>
          ...
          {data.description ? <p className="mt-4 text-lg text-muted-foreground">{data.description}</p> : null}
        </div>
